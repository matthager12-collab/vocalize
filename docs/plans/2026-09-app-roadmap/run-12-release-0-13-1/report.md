...
- T-111: done — manual checks 9–11 and 15–16 verified in runs 11 and 11b; 0.13.1 published to PyPI from `dist/` with token injected via `op run`; PyPI digests equal the local build sha256.
...
Suite: 2,231 passed, 3 skipped. Ruff clean. Gate 14 of 14 passed.
