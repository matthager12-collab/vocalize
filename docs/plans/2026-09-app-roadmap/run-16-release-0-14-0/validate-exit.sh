#!/usr/bin/env bash
# validate-exit.sh — Run 16: release-0-14-0
#
...
PASS=0
FAIL=0
# Release phase 6's full suite ran ~213s on this machine — 300s leaves headroom
# over the 120s default so "full suite green" isn't a coin-flip timeout.
...
echo ""
echo "=== Exit criteria ==="
check "review findings file exists" test -f docs/plans/2026-09-app-roadmap/review-0.14.0.md
